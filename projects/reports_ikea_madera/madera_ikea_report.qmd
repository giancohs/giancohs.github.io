...
#### Importaciones de madera sin procesar del grupo Falabella por país de venta (Origen)
...
#### Importaciones de madera procesada por país de origen
...
###### Porcentaje del grupo Ikano respecto al total de importaciones de madera sin procesar
...
mexico_imports_madera_clean %>% 
  ...
  ggplot(
   ...
   geom_bar(position = "stack",
             stat = "identity")+
    labs(fill = "Grupo empresas",
         title = "Evolución de importaciones de Grupo Ikano en Colombia",
         subtitle = "Madera procesada, por peso KG",
         y = "Peso KG",
         x = "Año")+
  scale_y_continuous(labels=function(x) format(x, big.mark = ".", scientific = FALSE))
